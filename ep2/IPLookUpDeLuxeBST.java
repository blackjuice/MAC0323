 ...
 *  exercicio 4.4.8
 *
 *  Compilation:    javac-algs4 IPLookUpDeLuxeBST.java
 *  Execution:      java-algs4 IPLookUpDeLuxeBST dbip-city-2015-05h.csv < file
...
public class IPLookUpDeLuxeBST implements Comparable<IPLookUpDeLuxeBST>{
     ...
     */
    public IPLookUpDeLuxeBST(long inicioInt, long fimInt) {
        this.inicioInt =    inicioInt;
        this.fimInt =       fimInt;
    }

    public int compareTo(IPLookUpDeLuxeBST that) {                     

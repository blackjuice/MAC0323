	...
	public static void main(String[] args) {
		...
		for (int i = 0; i <= N; i++) {
			for (int j = 0; j <= i; j++) {
				...
				//pqL.insert(new ComputationNumber(j, i, 0, 0));
				//pqL.insert(new ComputationNumber(0, 0, i, j));
				//pqL.insert(new ComputationNumber(0, 0, j, i));
			}
		}
...
*/
		...
		left.sumL == right_inv.sumR 	||
		left_inv.sumL == right.sumR 	||
		left_inv.sumL == right_inv.sumR ||
...
/** This application program creates an alphabet specified on the command line, 
 * reads in a sequence of characters over that alphabet 
 * (ignoring characters  not in the alphabet), 
 * computes the frequency of occurrence of each character, 
 * and print out the results.<br>
 * This program is a client of the Alphabet ADT.
 * <p>
 * For additional documentation, 
 * see Section xxxxx (p.xxx) of

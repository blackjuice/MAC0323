...
/** Given N points in the plane, find the closest pair in N log N time.<br>
 * Note: could speed it up by comparing square of Euclidean distances
 * instead of Euclidean distances.<p>
 *
 * Uses the followinf ADTs:
 * algs4/Point2D, Arrays.sort, 
 */
public class ClosestPair {
    ...
    /** Unit test client.
     * Ignores command-line arguments; reads data from standard input.
     * Reads N, then reads the x- and y-coordinates of N points.
     * Prints coordinates of a pair of points that is closest 
     * on the plane.
     */
